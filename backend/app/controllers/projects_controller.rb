...
class ProjectsController < ApplicationController
  ...
  # before_action :authenticate_user!
      ...
      def project_params
        params.require(:project).permit( :mac, :cut, :page, :reference, :assigneeName, :assigneeEmail, :assigneePhone, :details, :assignmentDate, :techName, :techEmail, :techPhone, :notes, :oDate, :projectTitle, :stamp, :description, :usable, :inUse, :reserved, :archived, :status, :user_id)
      end
    end
