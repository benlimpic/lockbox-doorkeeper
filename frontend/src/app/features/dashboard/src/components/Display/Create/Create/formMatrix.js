  ...
  return (
    <div>
      {isLoading ? (
        ...
        <Container className="App" style={{backgroundColor: "white", paddingTop: "15px", paddingBottom: "15px", borderRadius: ".75rem", marginTop: "15px", marginBottom: "40px"}}>
        <Form onSubmit={handleSubmit} style={{margin: "auto", width: "95%"}}>
        <Row>
          <Form.Group as={Col}>
        ...
        <br></br>
          ...
          <Form.Group>
            <Form.Label><h3>Site Details:</h3></Form.Label>
          </Form.Group>
        ...
        <Form.Group>
          ...
          <Form.Group>
            <Form.Label><h3>Contact Details:</h3></Form.Label>
          </Form.Group>
